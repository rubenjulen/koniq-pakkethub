        ...
        <details className="ph-card p-4" open={!s.visible}>
          ...
          <form action={publishRequestAction} className="mt-3 grid gap-2 sm:grid-cols-2">
            ...
            <label className="flex items-start gap-2 text-sm sm:col-span-2">
              <input type="checkbox" name="public_listed" defaultChecked={s.public_listed} className="mt-0.5" />
              <span>{pm.pub_public}<span className="block text-xs text-slate-500">{pm.pub_public_hint_req}</span></span>
            </label>
